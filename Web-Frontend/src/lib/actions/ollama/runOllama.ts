...
import { isOllamaServerRunning } from "./isOllamaRunning";
import { unloadAllModels } from "./unloadAllModels";
import { getOllamaPath } from "./ollamaPath";
...
async function startOllamaServer(): Promise<void> {
  try {
    ...
    console.log("Error starting Ollama server:", error);
    throw error;
  }
}
